...
{
    private readonly ResendConfirmationEmailRequestValidator _validator;

    public ResendConfirmationEmailRequestValidatorTests()
    {
        _validator = new ResendConfirmationEmailRequestValidator();
    }
    ...
    {
        // Arrange
        var request = new ResendConfirmationEmailRequest(string.Empty);
    ...
    {
        // Arrange
        var request = new ResendConfirmationEmailRequest("invalid-email-format");
    ...
    {
        // Arrange
        var request = new ResendConfirmationEmailRequest(validEmail);
