...
public class ResendPasswordlessLoginRequestValidatorTests
{
    private readonly ResendPasswordlessLoginRequestValidator _validator;

    public ResendPasswordlessLoginRequestValidatorTests()
    {
        _validator = new ResendPasswordlessLoginRequestValidator();
    }
    ...
    {
        // Arrange
        var request = new ResendPasswordlessLoginRequest(string.Empty);
    ...
    {
        // Arrange
        var request = new ResendPasswordlessLoginRequest("invalid-email-format");
    ...
    {
        // Arrange
        var request = new ResendPasswordlessLoginRequest(validEmail);
    ...
    {
        // Arrange
        var request = new ResendPasswordlessLoginRequest("valid@example.com");
